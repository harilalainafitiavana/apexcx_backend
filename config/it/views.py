...
class EquipementViewSet(viewsets.ModelViewSet):
    ...
    - GET /api/it/equipements/par-poste/{poste_id}/ : Équipements d'un poste
    """
    ...
    def get_queryset(self):
        ...
        projet_id = self.request.query_params.get('projet_id', None)
        if projet_id:
    ...
    def changer_statut(self, request, pk=None):
        ...
        # Règle métier : hors "affecté", l'équipement retourne au stock
        if nouveau_statut != Equipement.Statut.AFFECTE:
